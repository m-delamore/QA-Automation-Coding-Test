...
describe('sortNumbers', function() {
    ...
    it('is able to arrange an array of 10 unique numbers in ascending order', function() {
        const input = [100, 18, 25, 46, 81, 73, 20, 35, 1, 28];
        const expectedOutput = [1, 18, 20, 25, 28, 35, 46, 73, 81, 100];
...
describe('sumNumbers', function() {
    it('returns the correct sum of two numbers between 0 and 100', function() {
        const num1 = 37;
        const num2 = 99;
    ...
    it('throws an error if either number is not between 0 and 100', function() {
        const num1 = 101;
        const num2 = 37;
